...
r = 400
M = 24
working_directory = 'F:/mhasan/experiments/GlobalCDA/SA_mississippi/replication_two/'
...
def main():
    ...
    d_locallake = WGapOutput.read_unf('output_R2/LocalLake_km3.15.unf0')
    d_globallake = WGapOutput.read_unf('output_R2/GlobalLake_km3.15.unf0')
    d_localwetland = WGapOutput.read_unf('output_R2/LocalWetland_km3.15.unf0')
    d_globalwetland = WGapOutput.read_unf('output_R2/GlobalWetland_km3.15.unf0')
    d_reservoir = WGapOutput.read_unf('output_R2/Reservoir_km3.15.unf0')
    d_river = WGapOutput.read_unf('output_R2/River_km3.15.unf0')
