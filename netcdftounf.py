...
model_cells = WaterGapIO.model_cell_within_bbox(lon_min=lon_min, lat_min=lat_min, lon_max=lon_max, lat_max=lat_max)
...
succeed = WaterGapIO.netcdf_to_unf(netcdf_filename=filename, output_directory=output_directory,
